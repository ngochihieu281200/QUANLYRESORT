...
public class XMail
{
    ...
    {
        var from = "Victory Hotel<nguyenhoanghai16051996@gmail.com>";
    ...
    public static void Send(String from, String to, String cc, String bcc, String subject, String body, String attachments)
    {
        ...
        message.From = new MailAddress(from, from, Encoding.UTF8);
        ...
        {
            Credentials = new NetworkCredential("nguyenhoanghai16051996@gmail.com", "yitletgapxvdzxfj"),
            EnableSsl = true
        };
        // Gởi mail
        client.Send(message);
